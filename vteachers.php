    ...
    <div class="row">
        ...
        <div class="col-md-9">
                ...
                <?php
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while($row = $result->fetch_assoc()) {
                         echo "<tr><td> " . $row["name"]. " </td><td> ". $row["salary"]. " </td><td> ".$row["shift"]." </td><td> ".$row["dob"]." </td><td> ".$row["attendance"]." </td><td> ".$row["address"]." </td><td> ".$row["mobileno"]." </td><td> ".$row["class"]." </td><td> ".$row["id"]."</td></tr>";
                        }
                    } else {
                        echo "0 results";
                    }
            ?>
                 ...
                 <a class="export" href="teacherexcel.php">Click Here To Export</a>
            </div>
